...
/**
 * Interactive canvas dot grid — dots bulge away from the cursor and a soft
 * radial glow follows it. Purely decorative, so it disables itself under
...
const DotField = memo(function DotField({
  ...
  // useId (not Math.random()) — must match between the server-rendered HTML
  // and the client's first render, or hydration fails.
  const glowId = useId();
  ...
  useEffect(() => {
    ...
    // Single non-animated frame for prefers-reduced-motion — no rAF loop, no mouse tracking.
